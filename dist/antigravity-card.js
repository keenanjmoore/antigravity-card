...
`;
var hr = Object.defineProperty, Dt = (s, e, t, i) => {
...
const br = gt(1), vr = gt(2), yr = gt(3), xr = gt(4), wr = [
  ...
  render() {
    ...
    return C`
      <div class="editor-container">
        <!-- 1. CORE & LAYOUT -->
        ${this._renderSection("core", "📦", "Core & Layout", _r, e)}
          ...
          ${a ? C`
            <div class="panel-body sub-buttons-master">
              ...
              <div class="sub-buttons-nested-list">
                ${this._renderSubButtonPanel(1, t, br, e)}
                ${this._renderSubButtonPanel(2, i, vr, e)}
                ${this._renderSubButtonPanel(3, r, yr, e)}
                ${this._renderSubButtonPanel(4, o, xr, e)}
              </div>
            </div>
          ` : S}
        </div>
...
var $r = Object.defineProperty, kr = Object.getOwnPropertyDescriptor, Ue = (s, e, t, i) => {
  for (var r = i > 1 ? void 0 : i ? kr(e, t) : e, o = s.length - 1, a; o >= 0; o--)
...
const Cr = "145";
console.info(
  `%c 🚀 ANTIGRAVITY-CARD (NO-ICON) %c v${Cr} `,
...
const Tr = /* @__PURE__ */ new Set([
  ...
  "white",
  "disabled"
]), Mr = /* @__PURE__ */ new Set(["hs", "xy", "rgb", "rgbw", "rgbww"]), Pr = /* @__PURE__ */ new Set([
  "binary_sensor",
  "sensor",
  "camera",
  "weather",
  ...
  "event",
  "counter"
]), fi = /^\d+\s*,\s*\d+\s*,\s*\d+$/, Er = /^\d+\s*,\s*\d+\s*,\s*\d+\s*,\s*[\d.]+$/, ot = /* @__PURE__ */ new Map();
function X(s) {
...
function Rr(s) {
  ...
  if (!t)
    return He.set(s, ""), "";
  let i = t;
  if (t.startsWith("#") || t.startsWith("rgb") || t.startsWith("hsl") || t.startsWith("var(") ? i = t : fi.test(t) ? i = `rgb(${t})` : Er.test(t) ? i = `rgba(${t})` : t.toLowerCase() === "state" ? i = "var(--state-icon-color, var(--primary-color))" : Ar.has(t.toLowerCase()) && (i = `var(--${t.toLowerCase()}-color, ${t.toLowerCase()})`), He.size >= ri) {
...
class ae extends Oe {
  ...
  _dispatchAction(e, t, i) {
    const r = i || this.config.entity, o = r ? r.split(".")[0] : "", a = Pr.has(o);
    let l = t;
  ...
  render() {
    ...
    if (Array.isArray(n))
      for (let P = 0; P < n.length; P++) {
        const W = n[P];
        W !== "onoff" && (_ = !0), W === "color_temp" && (y = !0), Mr.has(W) && (L = !0);
      }
