const Ze = globalThis, bt = Ze.ShadowRoot && (Ze.ShadyCSS === void 0 || Ze.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, mt = Symbol(), kt = /* @__PURE__ */ new WeakMap();
let Vt = class {
  constructor(e, t, i) {
  ...
  get styleSheet() {
    ...
    if (bt && e === void 0) {
      ...
      i && (e = kt.get(t)), e === void 0 && ((this.o = e = new CSSStyleSheet()).replaceSync(this.cssText), i && kt.set(t, e));
    }
    return e;
  }
  toString() {
...
}, Tt = bt ? (n) => n : (n) => n instanceof CSSStyleSheet ? ((e) => {
  let t = "";
  for (const i of e.cssRules) t += i.cssText;
  return ii(t);
})(n) : n;
const { is: oi, defineProperty: ni, getOwnPropertyDescriptor: ai, getOwnPropertyNames: si, getOwnPropertySymbols: li, getPrototypeOf: ci } = Object, je = globalThis, At = je.trustedTypes, di = At ? At.emptyScript : "", ui = je.reactiveElementPolyfillSupport, we = (n, e) => n, Qe = { toAttribute(n, e) {
  switch (e) {
    case Boolean:
      n = n ? di : null;
      break;
  ...
  return t;
} }, vt = (n, e) => !oi(n, e), Mt = { attribute: !0, type: String, converter: Qe, reflect: !1, useDefault: !1, hasChanged: vt };
...
let ae = class extends HTMLElement {
  ...
  _$AK(e, t) {
    ...
    if (r !== void 0 && this._$Em !== r) {
      const o = i.getPropertyOptions(r), a = typeof o.converter == "function" ? { fromAttribute: o.converter } : o.converter?.fromAttribute !== void 0 ? o.converter : Qe;
      this._$Em = r;
  ...
  requestUpdate(e, t, i, r = !1, o) {
    if (e !== void 0) {
      ...
      if (r === !1 && (o = this[e]), i ??= a.getPropertyOptions(e), !((i.hasChanged ?? vt)(o, t) || i.useDefault && i.reflect && o === this._$Ej?.get(e) && !this.hasAttribute(a._$Eu(e, i)))) return;
      this.C(e, t, i);
    }
...
ae.elementStyles = [], ae.shadowRootOptions = { mode: "open" }, ae[we("elementProperties")] = /* @__PURE__ */ new Map(), ae[we("finalized")] = /* @__PURE__ */ new Map(), ui?.({ ReactiveElement: ae }), (je.reactiveElementVersions ??= []).push("2.1.2");
const yt = globalThis, Pt = (n) => n, Je = yt.trustedTypes, Et = Je ? Je.createPolicy("lit-html", { createHTML: (n) => n }) : void 0, qt = "$lit$", W = `lit$${Math.random().toFixed(9).slice(2)}$`, Xt = "?" + W, _i = `<${Xt}>`, Q = document, Se = () => Q.createComment(""), Ce = (n) => n === null || typeof n != "object" && typeof n != "function", xt = Array.isArray, hi = (n) => xt(n) || typeof n?.[Symbol.iterator] == "function", dt = `[ 	
\f\r]`, ve = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Lt = /-->/g, Ht = />/g, X = RegExp(`>|${dt}(?:([^\\s"'>=/]+)(${dt}*=${dt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Rt = /'/g, Nt = /"/g, Kt = /^(?:script|style|textarea|title)$/i, pi = (n) => (e, ...t) => ({ _$litType$: n, strings: e, values: t }), $ = pi(1), J = Symbol.for("lit-noChange"), m = Symbol.for("lit-nothing"), Dt = /* @__PURE__ */ new WeakMap(), Z = Q.createTreeWalker(Q, 129);
function Zt(n, e) {
...
const gi = (n, e) => {
  ...
  for (let s = 0; s < t; s++) {
    const l = n[s];
    let d, _, c = -1, g = 0;
    for (; g < l.length && (a.lastIndex = g, _ = a.exec(l), _ !== null); ) g = a.lastIndex, a === ve ? _[1] === "!--" ? a = Lt : _[1] !== void 0 ? a = Ht : _[2] !== void 0 ? (Kt.test(_[2]) && (r = RegExp("</" + _[2], "g")), a = X) : _[3] !== void 0 && (a = X) : a === X ? _[0] === ">" ? (a = r ?? ve, c = -1) : _[1] === void 0 ? c = -2 : (c = a.lastIndex - _[2].length, d = _[1], a = _[3] === void 0 ? X : _[3] === '"' ? Nt : Rt) : a === Nt || a === Rt ? a = X : a === Lt || a === Ht ? a = ve : (a = X, r = void 0);
    const h = a === X && n[s + 1].startsWith("/>") ? " " : "";
    o += a === ve ? l + _i : c >= 0 ? (i.push(d), l.slice(0, c) + qt + l.slice(c) + W + h) : l + W + (c === -2 ? s : h);
  }
...
class ke {
  constructor({ strings: e, _$litType$: t }, i) {
    ...
    if (this.el = ke.createElement(d, i), Z.currentNode = this.el.content, t === 2 || t === 3) {
    ...
    for (; (r = Z.nextNode()) !== null && l.length < s; ) {
      if (r.nodeType === 1) {
        if (r.hasAttributes()) for (const c of r.getAttributeNames()) if (c.endsWith(qt)) {
          const g = _[a++], h = r.getAttribute(c).split(W), b = /([.?@])?(.*)/.exec(g);
          l.push({ type: 1, index: o, name: b[2], strings: h, ctor: b[1] === "." ? bi : b[1] === "?" ? mi : b[1] === "@" ? vi : et }), r.removeAttribute(c);
        } else c.startsWith(W) && (l.push({ type: 6, index: o }), r.removeAttribute(c));
        if (Kt.test(r.tagName)) {
          const c = r.textContent.split(W), g = c.length - 1;
          if (g > 0) {
            r.textContent = Je ? Je.emptyScript : "";
            for (let h = 0; h < g; h++) r.append(c[h], Se()), Z.nextNode(), l.push({ type: 2, index: ++o });
            r.append(c[g], Se());
          }
        }
...
function le(n, e, t = n, i) {
  if (e === J) return e;
  let r = i !== void 0 ? t._$Co?.[i] : t._$Cl;
  const o = Ce(e) ? void 0 : e._$litDirective$;
  return r?.constructor !== o && (r?._$AO?.(!1), o === void 0 ? r = void 0 : (r = new o(n), r._$AT(n, t, i)), i !== void 0 ? (t._$Co ??= [])[i] = r : t._$Cl = r), r !== void 0 && (e = le(n, r._$AS(n, e.values), r, i)), e;
}
class fi {
  constructor(e, t) {
  ...
  u(e) {
    ...
    Z.currentNode = r;
    let o = Z.nextNode(), a = 0, s = 0, l = i[0];
    for (; l !== void 0; ) {
      if (a === l.index) {
        let d;
        l.type === 2 ? d = new ce(o, o.nextSibling, this, e) : l.type === 1 ? d = new l.ctor(o, l.name, l.strings, this, e) : l.type === 6 && (d = new yi(o, this, e)), this._$AV.push(d), l = i[++s];
      }
...
class ce {
  ...
  _$AI(e, t = this) {
    e = le(this, e, t), Ce(e) ? e === m || e == null || e === "" ? (this._$AH !== m && this._$AR(), this._$AH = m) : e !== this._$AH && e !== J && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : hi(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== m && Ce(this._$AH) ? this._$AA.nextSibling.data = e : this.T(Q.createTextNode(e)), this._$AH = e;
  }
  $(e) {
  ...
  _$AC(e) {
    ...
    return t === void 0 && Dt.set(e.strings, t = new ke(e)), t;
  }
  k(e) {
...
class et {
  ...
  _$AI(e, t = this, i, r) {
    ...
    let a = !1;
    if (o === void 0) e = le(this, e, t, 0), a = !Ce(e) || e !== this._$AH && e !== J, a && (this._$AH = e);
    else {
      const s = e;
      let l, d;
      for (e = o[0], l = 0; l < o.length - 1; l++) d = le(this, s[i + l], t, l), d === J && (d = this._$AH[l]), a ||= !Ce(d) || d !== this._$AH[l], d === m ? e = m : e !== m && (e += (d ?? "") + o[l + 1]), this._$AH[l] = d;
    }
    a && !r && this.j(e);
  }
  j(e) {
...
const xi = { I: ce }, $i = yt.litHtmlPolyfillSupport;
$i?.(ke, ce), (yt.litHtmlVersions ??= []).push("3.3.3");
const wi = (n, e, t) => {
...
se._$litElement$ = !0, se.finalized = !0, $t.litElementHydrateSupport?.({ LitElement: se });
const Si = $t.litElementPolyfillSupport;
Si?.({ LitElement: se });
($t.litElementVersions ??= []).push("4.2.2");
const Ci = { attribute: !0, type: String, converter: Qe, reflect: !1, hasChanged: vt }, ki = (n = Ci, e, t) => {
...
function tt(n) {
  return (e, t) => typeof t == "object" ? ki(n, e, t) : ((i, r, o) => {
...
const { I: Pi } = xi, Bt = (n) => n, Ot = () => document.createComment(""), ye = (n, e, t) => {
  ...
  return t;
}, K = (n, e, t = n) => (n._$AI(e, t), n), Ei = {}, Li = (n, e = Ei) => n._$AH = e, Hi = (n) => n._$AH, ut = (n) => {
...
const zt = (n, e, t) => {
  ...
  update(n, [e, t, i]) {
    ...
    const s = this.ut ??= [], l = [];
    let d, _, c = 0, g = r.length - 1, h = 0, b = o.length - 1;
    for (; c <= g && h <= b; ) if (r[c] === null) c++;
    else if (r[g] === null) g--;
    else if (s[c] === a[h]) l[h] = K(r[c], o[h]), c++, h++;
    else if (s[g] === a[b]) l[b] = K(r[g], o[b]), g--, b--;
    else if (s[c] === a[b]) l[b] = K(r[c], o[b]), ye(n, l[b + 1], r[c]), c++, b--;
    else if (s[g] === a[h]) l[h] = K(r[g], o[h]), ye(n, r[c], r[g]), g--, h++;
    else if (d === void 0 && (d = zt(a, h, b), _ = zt(s, c, g)), d.has(s[c])) if (d.has(s[g])) {
      const y = _.get(a[h]), S = y !== void 0 ? r[y] : null;
      if (S === null) {
        const p = ye(n, r[c]);
        K(p, o[h]), l[h] = p;
      } else l[h] = K(S, o[h]), ye(n, r[c], S), r[y] = null;
      h++;
    } else ut(r[g]), g--;
    else ut(r[c]), c++;
    for (; h <= b; ) {
...
var Ui = Object.defineProperty, wt = (n, e, t, i) => {
...
const qi = rt(1), Xi = rt(2), Ki = rt(3), Zi = rt(4), Qi = [
...
var ji = Object.defineProperty, er = Object.getOwnPropertyDescriptor, de = (n, e, t, i) => {
...
const ft = [
  ...
  { k: 2200, label: "2200K", rgb: G(2200) },
  { k: 2700, label: "2700K", rgb: G(2700) },
  { k: 3e3, label: "3000K", rgb: G(3e3) },
  { k: 4e3, label: "4000K", rgb: G(4e3) },
  { k: 5e3, label: "5000K", rgb: G(5e3) },
  { k: 6500, label: "6500K", rgb: G(6500) }
...
function dr(n) {
  ...
  if (!t)
    return ne.set(n, ""), "";
  let i = t;
  if (t.startsWith("#") || t.startsWith("rgb") || t.startsWith("hsl") || t.startsWith("var(") ? i = t : Jt.test(t) ? i = `rgb(${t})` : nr.test(t) ? i = `rgba(${t})` : t.toLowerCase() === "state" ? i = "var(--state-icon-color, var(--primary-color))" : rr.has(t.toLowerCase()) && (i = `var(--${t.toLowerCase()}-color, ${t.toLowerCase()})`), ne.size >= Wt) {
...
class V extends se {
  ...
  _computeStaticStylesAndClasses() {
    ...
    const e = this.config.card_padding ?? 12, t = this.config.card_padding_vertical ?? 4, i = this.config.card_padding_horizontal ?? e, r = this.config.card_padding_top ?? t, o = this.config.card_padding_bottom ?? t, a = this.config.card_padding_left ?? i, s = this.config.card_padding_right ?? i, l = this.config.card_margin, d = this.config.card_margin_vertical ?? l, _ = this.config.card_margin_horizontal ?? l, c = this.config.card_margin_top ?? d, g = this.config.card_margin_bottom ?? d, h = this.config.card_margin_left ?? _, b = this.config.card_margin_right ?? _;
    let y = "";
    (c !== void 0 || g !== void 0 || h !== void 0 || b !== void 0) && (y = `margin: ${c ?? 0}px ${b ?? 0}px ${g ?? 0}px ${h ?? 0}px;`);
    const S = this.config.border_radius ?? 12, p = this.config.slider_style === "google", C = this.config.slider_style === "full", f = p ? 42 : C ? 40 : 12, k = this.config.slider_height !== void 0 ? this.config.slider_height : f, x = p ? 21 : C ? 0 : k / 2, w = this.config.slider_border_radius !== void 0 ? this.config.slider_border_radius : x, T = this.config.card_border_width ?? (this.config.card_border_color ? 1 : 0), u = this.config.card_border_style ?? "solid", v = T > 0 ? `border: ${T}px ${u} ${this._resolveColor(this.config.card_border_color) || "var(--divider-color, rgba(150, 150, 150, 0.2))"};` : "", A = this.config.card_width ? `width: ${this.config.card_width};` : "", O = this.config.card_max_width ? `max-width: ${this.config.card_max_width};` : "", Y = this.config.card_height ? `height: ${this.config.card_height};` : "", j = this.config.card_min_height !== void 0 ? `min-height: ${this.config.card_min_height}px;` : "", q = this.config.fill_container === !0 ? "height: 100%; width: 100%;" : "", ue = this.config.overflow_hidden !== !1 ? "overflow: hidden;" : "overflow: visible;", Me = this.config.backdrop_blur !== void 0 ? `backdrop-filter: blur(${this.config.backdrop_blur}px); -webkit-backdrop-filter: blur(${this.config.backdrop_blur}px);` : "", Pe = this.config.card_opacity !== void 0 ? `opacity: ${this.config.card_opacity / 100};` : "", Ee = this.config.transition_duration !== void 0 ? `transition: all ${this.config.transition_duration}ms ease;` : "", U = this.config.text_padding_vertical ?? this.config.text_padding ?? 0, Le = this.config.text_padding_horizontal ?? this.config.text_padding ?? 0, He = this.config.features_padding_vertical ?? this.config.features_padding ?? 0, Re = this.config.features_padding_horizontal ?? this.config.features_padding ?? 0, Ne = this.config.sub_button_padding ?? 0, De = this.config.sub_button_container_padding ?? 0, Be = this.config.sub_button_alignment ? `--ag-sub-button-alignment: ${this.config.sub_button_alignment};` : "", ot = this.config.text_scrolling_speed ? `--ag-scroll-speed: ${this.config.text_scrolling_speed}s;` : "", nt = this.config.full_slider_opacity !== void 0 ? `--ag-full-slider-opacity: ${this.config.full_slider_opacity / 100};` : "";
    ...
    const Oe = Number(this.config.text_offset_x) || 0, H = Number(this.config.text_offset_y) || 0;
    this._textOffsetStyle = Oe !== 0 || H !== 0 ? `transform: translate(${Oe}px, ${H}px);` : "";
    const F = Number(this.config.primary_text_start_offset ?? this.config.primary_text_offset_x) || 0, _e = Number(this.config.primary_text_end_offset) || 0, N = Number(this.config.primary_text_offset_y) || 0, he = F !== 0 || N !== 0 ? `transform: translate(${F}px, ${N}px);` : "", ee = F !== 0 || _e !== 0 ? `margin-left: ${F}px; margin-right: ${_e}px;` : "";
    this._primaryTextOffsetStyle = `${he} ${ee}`.trim();
    const te = Number(this.config.secondary_text_start_offset ?? this.config.secondary_text_offset_x) || 0, D = Number(this.config.secondary_text_end_offset) || 0, ze = Number(this.config.secondary_text_offset_y) || 0, at = te !== 0 || ze !== 0 ? `transform: translate(${te}px, ${ze}px);` : "", st = te !== 0 || D !== 0 ? `margin-left: ${te}px; margin-right: ${D}px;` : "";
    this._secondaryTextOffsetStyle = `${at} ${st}`.trim();
    ...
    const I = Number(this.config.color_temp_start_offset) || 0, Fe = Number(this.config.color_temp_end_offset) || 0;
    this._colorTempMarginOffsets = [
      I ? `margin-left: ${I}px !important;` : "",
      Fe ? `margin-right: ${Fe}px !important;` : ""
    ].filter(Boolean).join(" ");
    const Ge = Number(this.config.color_slider_start_offset) || 0, pe = Number(this.config.color_slider_end_offset) || 0;
    ...
    const We = this.config.text_transform_primary && this.config.text_transform_primary !== "none" ? `text-transform: ${this.config.text_transform_primary};` : "", Ve = `text-transform: ${this.config.text_transform_secondary ?? "capitalize"};`, re = this.config.letter_spacing ? `letter-spacing: ${this.config.letter_spacing}px;` : "", Ye = this.config.line_height ? `line-height: ${this.config.line_height};` : "", ge = this.config.font_weight_primary ?? "800";
    this._primaryTextStyle = `font-size: ${this.config.font_size_primary ?? 14}px; font-weight: ${ge}; ${We} ${re} ${Ye}`, this._secondaryTextStyle = `font-size: ${this.config.font_size_secondary ?? 15}px; ${Ve} ${re} ${Ye}`;
    const M = this.config.entity, oe = [];
    for (let P = 1; P <= 4; P++) {
      const fe = this.config[`sub_button_${P}_entity`], be = this.config[`sub_button_${P}_icon`], qe = this.config[`sub_button_${P}_name`], lt = this.config[`sub_button_${P}_tap_action`], me = this.config[`sub_button_${P}_hold_action`], jt = this.config[`sub_button_${P}_double_tap_action`], ct = this.config[`sub_button_${P}_type`], ei = this.config[`sub_button_${P}_color`], ti = this.config[`sub_button_${P}_show_background`], St = this.config[`sub_button_${P}_show_state`];
      if (!!(fe || be || qe || ct && ct !== "button" || St)) {
        const Ct = fe || M;
    ...
    if (this._cachedSubButtons = Object.freeze(oe), this.config.fade_transition_enabled) {
      const P = Number(this.config.fade_stage_1_duration) || 60, fe = Number(this.config.fade_stage_2_duration) || 600, be = Number(this.config.fade_stage_3_duration) || 1800, qe = B(this.config.fade_stage_1_color) || [255, 152, 0], lt = B(this.config.fade_stage_2_color) || [205, 220, 57], me = B(this.config.fade_stage_3_color);
  ...
  _calculateMultiStageFade(e, t, i) {
    ...
    let u, v = 1, A = 0;
    const O = Math.max(0, Math.round(y - T));
    T < g && g > 0 ? (v = 1, A = T / g, u = ht(S, p, A)) : T < g + h && h > 0 ? (v = 2, A = (T - g) / h, u = ht(C, f, A)) : b > 0 ? (v = 3, A = (T - g - h) / b, u = ht(k, x, A)) : (v = 0, u = x), this._currentLiveRgb = u;
    const Y = Math.min(100, Math.round(T / y * 100)), j = pt(u);
    let q = "";
  ...
  _sliderInput(e, t, i, r, o, a, s) {
    ...
    const _ = Number(l.value), c = isNaN(_) ? 0 : _, g = a ? a(c) : c;
    if (d) {
    ...
    requestAnimationFrame(() => {
      ...
      if (b && (b.textContent = s ? s(c, g) : `${g}%`), t === "color_hue" && h) {
  ...
  _getLightLiveColor(e) {
    ...
    const t = e.attributes, i = t.color_mode;
    if (i === "hs" || i === "rgb" || i === "xy" || i === "rgbw" || i === "rgbww") {
      ...
      if (Array.isArray(t.hs_color) && t.hs_color.length >= 2) {
        const [o, a, s] = _t(t.hs_color[0], t.hs_color[1]);
        return `rgb(${o}, ${a}, ${s})`;
      }
    ...
    if (this.config.use_light_color && (i === "color_temp" || t.color_temp_kelvin !== void 0 || t.color_temp !== void 0)) {
      const o = t.color_temp_kelvin ?? (t.color_temp ? Math.round(1e6 / t.color_temp) : 3e3), [a, s, l] = G(o);
      return `rgb(${a}, ${s}, ${l})`;
    }
    return e.state === "on" ? "var(--state-light-active-color, var(--state-light-color, rgb(255, 205, 120)))" : null;
  }
  _getLiveHex(e) {
    if (!e?.attributes || e.state !== "on") return "#ffffff";
    const t = e.attributes;
    if (Array.isArray(t.rgb_color) && t.rgb_color.length >= 3)
      return Xe(t.rgb_color);
    if (Array.isArray(t.hs_color) && t.hs_color.length >= 2)
      return Xe(_t(t.hs_color[0], t.hs_color[1]));
  ...
  render() {
    ...
    a === "climate" ? t.state === "heat" ? s = "var(--state-climate-heat-color, #ff7043)" : t.state === "cool" ? s = "var(--state-climate-cool-color, #42a5f5)" : t.state === "dry" ? s = "var(--state-climate-dry-color, #ab47bc)" : t.state === "fan_only" && (s = "var(--state-climate-fan_only-color, #26a69a)") : a === "light" ? (l = this._getLightLiveColor(t), l && (s = l)) : (a === "binary_sensor" || a === "lock" || a === "switch") && (s = "#d60000");
    const d = this.config.color_type === "card";
    let _ = this._resolveColor(this.config.active_color);
    (!_ || this.config.use_light_color) && (a === "light" && l ? _ = l : _ = s);
    let c = "var(--secondary-background-color, rgba(150, 150, 150, 0.2))";
    a === "light" ? c = "#000000" : (a === "binary_sensor" || a === "lock" || a === "switch") && (c = "#03b500");
    const g = this._resolveColor(this.config.inactive_color) || c, h = this.config.show_slider !== !1, b = a === "light", y = a === "cover", S = a === "fan", p = a === "humidifier", C = a === "media_player", f = a === "number" || a === "input_number", k = a === "climate", x = this.config.hide_slider_when_off !== !1, w = this.config.hide_color_temp_when_off !== !1, T = this.config.hide_color_picker_when_off !== !1, u = this.config.hide_color_slider_when_off !== !1, v = t.attributes?.supported_color_modes;
    let A = t.attributes?.brightness !== void 0, O = !1, Y = !1;
    if (Array.isArray(v))
      for (let M = 0; M < v.length; M++) {
        const oe = v[M];
        oe !== "onoff" && (A = !0), oe === "color_temp" && (O = !0), or.has(oe) && (Y = !0);
      }
    const j = b && h && A && (!x || o), q = t.attributes?.color_temp_kelvin ?? t.attributes?.color_temp, ue = b && this.config.show_color_temp === !0 && (q !== void 0 || O) && (!w || o), Me = this.config.color_picker_type !== "wheel", Pe = b && (this.config.show_color_slider === !0 || this.config.show_color_picker === !0 && Me) && Y && (!u || o), Ee = b && this.config.show_color_picker === !0 && !Me && Y && (!T || o), U = t.state !== "unavailable" && t.state !== "unknown", Le = y && U && h && t.attributes?.current_position !== void 0, He = S && U && o && h && t.attributes?.percentage !== void 0, Re = p && U && o && h && (t.attributes?.humidity !== void 0 || t.attributes?.target_humidity !== void 0), Ne = C && U && o && h && t.attributes?.volume_level !== void 0, De = f && U && h, Be = k && U && o && h && (t.attributes?.temperature !== void 0 || t.attributes?.target_temp_high !== void 0), ot = (this.config.bg_opacity ?? 10) / 100, nt = this.config.slider_color ? `--slider-color: ${this._resolveColor(this.config.slider_color)};` : d && o && !this.config.use_light_color ? "--slider-color: rgba(255, 255, 255, 0.95);" : `--slider-color: ${_};`, Oe = this.config.slider_track_color ? `--slider-track-color: ${this._resolveColor(this.config.slider_track_color)};` : d && o ? "--slider-track-color: rgba(0, 0, 0, 0.25);" : "", H = this._calculateMultiStageFade(t, s, g), F = this.config.fade_target ?? "card", _e = this._resolveColor(this.config.bg_color);
    let N;
    H.activeFade && (F === "card" || F === "all" || d) ? N = H.currentColor : d ? a === "light" ? N = o ? l || _ : this.config.inactive_color ? g : "#000000" : N = o ? _ : g : _e ? N = _e : a === "light" && !o ? N = "#000000" : N = `rgba(150, 150, 150, ${ot})`;
    let he = this._resolveColor(this.config.active_color) || (a === "light" && l ? l : _) || "var(--primary-color)";
    H.activeFade && (F === "all" || this.config.active_glow === !0) && (he = H.currentColor);
    let ee = "";
    this.config.box_shadow === "soft" && (ee = "box-shadow: 0 4px 10px rgba(0,0,0,0.1);"), this.config.box_shadow === "deep" && (ee = "box-shadow: 0 10px 20px rgba(0,0,0,0.3);"), (this.config.box_shadow === "glow" || this.config.active_glow === !0) && (ee = o || H.activeFade ? `box-shadow: 0 0 22px ${he}, 0 0 45px rgba(255, 255, 255, 0.18);` : "");
    const te = this.config.active_glow === !0 || this.config.box_shadow === "glow" ? "card-active-glow" : "", D = t?.attributes?.device_class, ze = a === "binary_sensor" && (D === "motion" || D === "occupancy" || D === "presence"), at = a === "binary_sensor" && (D === "door" || D === "window" || D === "garage_door" || D === "opening"), st = ze && (o || H.activeFade && H.currentStage === 1) ? "motion-active" : "", Ie = at && o ? "door-open" : "", Ue = `${this._staticCardClasses} ${te} ${st} ${Ie}`, ie = this._getSubButtons();
    ...
    const I = this.config.features_position === "inline", Fe = this.config.text_scrolling_primary || "none", Ge = this.config.text_scrolling_secondary || "none", pe = $`
      ${j ? this._renderLightSlider(t) : m}
      ${Le ? this._renderCoverSlider(t) : m}
      ${He ? this._renderFanSlider(t) : m}
      ${Re ? this._renderHumidifierSlider(t) : m}
      ${Ne ? this._renderMediaSlider(t) : m}
      ${De ? this._renderNumberSlider(t) : m}
      ${Be ? this._renderClimateSlider(t) : m}
    `, We = $`
      ${ue ? this._renderColorTempSlider(t) : m}
      ${Pe ? this._renderColorSlider(t) : m}
      ${Ee ? this._renderColorPicker(t) : m}
    `, Ve = j || Le || He || Re || Ne || De || Be, re = ue || Pe || Ee, Ye = !I && re || ie.length > 0, ge = this.config.decay_slider_position ?? "bottom";
    return $`
      ...
      <ha-card 
        ...
        class="${Ue}" 
        ?active=${o}
        style="${this._staticCardStyles} background: ${N}; ${ee} ${nt} ${Oe} ${z} --ag-glow-color: ${he}; --ag-active-color: ${_};"
      ...
      >
        <div class="card-content ${I ? "features-inline" : ""}" style="justify-content: var(--ag-content-alignment);">
          ${ge === "top" ? this._renderDecaySlider(H) : m}

          <div class="info-container">
            <div class="info" style="${this._textOffsetStyle} ${this._textBoxWidth} text-align: var(--ag-text-alignment);">
              ${i ? $`
                <div class="text-marquee-container scroll-${Fe}" style="${this._primaryTextOffsetStyle}">
                  <span class="primary scroll-content" style="${this._primaryTextStyle}">${i}</span>
                </div>` : m}
              ${r ? $`
                <div class="text-marquee-container scroll-${Ge}" style="${this._secondaryTextOffsetStyle}">
                  <span class="secondary scroll-content" style="${this._secondaryTextStyle}">${r}</span>
                </div>` : m}
            </div>
            ${ge === "inline" ? $`<div class="inline-sliders">${this._renderDecaySlider(H)}</div>` : m}
            ${I && Ve ? $`<div class="inline-sliders" style="${this._mainSliderMarginOffsets}">${pe}</div>` : m}
            ${I && re ? $`<div class="inline-sliders ${this._collapsed ? "collapsed" : ""}">${We}</div>` : m}
          </div>
          
          ${ge === "bottom" ? this._renderDecaySlider(H) : m}
          ${!I && Ve ? $`<div class="features-container" style="${this._featuresOffsetStyle} ${this._mainSliderMarginOffsets}">${pe}</div>` : m}

          ${Ye ? $`
            <div class="collapsible-wrapper ${this._collapsed ? "collapsed" : ""}">
              ${!I && re ? $`<div class="features-container" style="${this._featuresOffsetStyle}">${We}</div>` : m}
  ...
  _renderGenericSlider(e, t, i, r, o, a, s, l, d, _, c, g, h = "", b = "", y) {
    const S = this.config.slider_style === "google", p = S && this.config.show_slider_percent !== !1 || this.config.show_slider_percent === !0, C = g ? g(a, s) : `${s}%`, f = y !== void 0 ? y : C, k = this.config.slider_stepped_movement === !1 ? "any" : o, x = e !== "color_temp" && e !== "color_hue", w = this.config.slider_style === "full", T = x && w ? "main-slider-full" : "";
    let u = "";
    if (x && w) {
    ...
    return $`
      <div class="slider-container ${h} ${T} ${S ? "slider-google-wrap" : ""}" style="${u} ${b}">
        <input type="range" min=${i} max=${r} step=${k} .value=${a}
               ...
               @input=${(v) => this._sliderInput(v, e, l, d, _, c, g)}
    ...
    if (t === "presets") {
      ...
      return $`
        <div class="presets-row" style="display: flex; gap: 6px; overflow-x: auto; padding: 2px 0; ${C}">
          ${sr.map((f) => {
        const [k, x, w] = f.rgb, T = Math.abs(a - f.k) < 200;
        return $`
              <button 
                type="button"
                tabindex="0"
                class="temp-preset-chip"
                style="flex: 1; min-width: 48px; height: ${h}px; border-radius: ${b}px; border: ${T ? "2px solid #ffffff" : "1px solid rgba(150, 150, 150, 0.3)"}; background: rgba(${k}, ${x}, ${w}, 0.2); color: var(--primary-text-color); font-size: 11px; font-weight: bold; cursor: pointer; display: flex; align-items: center; justify-content: center; gap: 4px; box-shadow: ${T ? "0 0 8px rgba(" + k + "," + x + "," + w + ", 0.8)" : "none"};"
                @click=${(u) => {
          u.stopPropagation(), L("light", this.config.haptic_feedback !== !1), this.hass.callService("light", "turn_on", { entity_id: this.config.entity, [d]: f.k });
                ...
                <span style="width: 8px; height: 8px; border-radius: 50%; background: rgb(${k}, ${x}, ${w}); display: inline-block;"></span>
                ${f.label}
              </button>
            `;
      })}
  ...
  _renderColorSlider(e) {
      ...
      return $`
        ...
        return $`
              <button 
                ...
                title="${C.label}"
                style="flex: 1; min-width: 28px; height: ${h}px; border-radius: ${b}px; background: ${C.hex}; border: ${f ? "2px solid #ffffff" : "1px solid rgba(0,0,0,0.2)"}; cursor: pointer; box-shadow: ${f ? "0 0 10px " + C.hex : "0 1px 3px rgba(0,0,0,0.3)"}; transition: transform 0.15s ease;"
                @click=${(k) => {
    ...
    return this._renderGenericSlider(
      ...
      "turn_on",
      (g) => {
        const [h, b, y] = _t(g, 100);
        return { rgb_color: [h, b, y] };
      },
      (g) => Math.round(g / 360 * 100),
      (g) => `${g}°`,
  ...
  _renderSubSlider(e, t, i, r, o) {
    ...
    let c = 0, g = 0, h = 255, b = "1", y = "turn_on", S = "light", p = "brightness";
    l ? (c = a?.attributes?.volume_level ?? 0, h = 1, b = "0.01", y = "set_volume_level", S = "media_player", p = "volume_level") : d ? (c = a?.attributes?.percentage ?? 0, h = 100, b = "1", y = "set_percentage", S = "fan", p = "percentage") : _ ? (c = a?.attributes?.current_position ?? 0, h = 100, b = "1", y = "set_cover_position", S = "cover", p = "position") : c = a?.attributes?.brightness ?? 0;
    ...
    return i === "slider" ? $`
        <div class="sub-button-slider-container ${o}" style="${r}" title="Level: ${C}%">
          <input type="range" 
                 ...
                 @input=${(f) => {
      f.stopPropagation();
      const k = parseFloat(f.target.value), x = Math.round(h === 1 ? k * 100 : h === 100 ? k : k / 255 * 100), w = f.target.closest(".sub-button-slider-container");
      ...
      ` : $`
        <div class="sub-button-google-slider ${o}" style="${r} --slider-pct: ${C}%;" title="Level: ${C}%">
          <input type="range" 
                 ...
                 @input=${(f) => {
      f.stopPropagation();
      const k = parseFloat(f.target.value), x = Math.round(h === 1 ? k * 100 : h === 100 ? k : k / 255 * 100), w = f.target;
  ...
  _renderSubButton(e, t, i, r = !0, o, a, s, l = "button", d, _ = !1) {
    ...
    if (e && !c)
      ...
      `;
    const g = c ? this._isEntityActive(c) : !1;
    let h = this._resolveColor(i);
    !h && g && c?.attributes?.rgb_color && Array.isArray(c.attributes.rgb_color) && (h = `rgb(${c.attributes.rgb_color.join(",")})`);
    const b = h ? `color: ${h};` : "", y = r ? "" : "no-bg", S = _ && c ? this._getInfoContent("state", c) : "";
    if (l === "slider" || l === "google_slider")
      return this._renderSubSlider(e, c, l, b, y);
    if (l === "color_picker")
      return this._renderSubColorPicker(e, c, b, y, o, S);
    let p = t, C = g, f = o || "", k = "", x = o, w;
    if (a && a.action && a.action !== "none" && a.action !== "default")
      ...
      switch (l) {
        case "play_pause": {
          ...
          C = u, p || (p = u ? "mdi:pause" : "mdi:play"), f = u ? "Pause" : "Play", w = () => {
        ...
        case "open_close": {
          ...
          C = u, p || (p = u ? "mdi:window-shutter-open" : "mdi:window-shutter"), f = u ? "Close" : "Open", w = () => {
        ...
        case "lock_unlock": {
          ...
          C = !u, p || (p = u ? "mdi:lock" : "mdi:lock-open-variant"), f = u ? "Unlock" : "Lock", w = () => {
        ...
        case "fan_speed": {
          ...
          p || (p = "mdi:fan"), g && (k = "anim-spin"), f = `Speed: ${u}%`, x || (x = u > 0 ? `${u}%` : "Off"), w = () => {
            let v = 33;
        ...
        case "clean": {
          ...
          C = u, p || (p = u ? "mdi:pause" : "mdi:robot-vacuum"), f = u ? "Pause Vacuum" : "Start Vacuum", w = () => {
        ...
        case "hvac_mode": {
          ...
          C = u !== "off", p || (u === "heat" ? p = "mdi:fire" : u === "cool" ? p = "mdi:snowflake" : u === "dry" ? p = "mdi:water-percent" : u === "fan_only" ? p = "mdi:fan" : u === "auto" ? p = "mdi:thermostat-auto" : p = "mdi:power"), f = `Mode: ${u} -> Next: ${A}`, x || (x = u), w = () => {
        ...
        case "light_effect": {
          ...
          p || (p = "mdi:creation"), C = v !== "None" && v !== "off" && g, f = `Effect: ${v} -> Next: ${A}`, x || (x = v !== "None" ? v : "Effect"), w = () => {
        ...
        case "garage_toggle": {
          ...
          C = u, p || (p = u ? "mdi:garage-open" : "mdi:garage"), f = u ? "Close Garage" : "Open Garage", w = () => {
            this.hass.callService("cover", "toggle", { entity_id: e || this.config.entity });
          };
          break;
        }
    ...
    return $`
      <div 
        ...
        class="sub-button ${y}" 
        ?active=${C} 
        style="${b} ${C && h && r ? `background: ${h}; color: #fff;` : ""}"
        title="${f}"
        @click=${T}
        @keydown=${(u) => {
